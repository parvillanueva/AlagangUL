	 		...
	 		<div class="box-body">   
	 			<div id = "badge" class="form-horizontal">
		            ...
		            <div class="form-group">
		              	...
		              	<div class="col-sm-5">
		                	<input id="name" name="name" class="form-control required_input">
		              	</div>
		            </div>
		            <div class="form-group">
		              	...
		              	<div class="col-sm-5">
		              		<div class="input-group"> 
			                	<input id="icon" name="icon"  class="form-control required_input" readonly>
