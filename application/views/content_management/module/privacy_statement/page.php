<div class="box">
    ...
    <div class="box-body">
        <?php
            $id = 1;
            $top_details = $this->load->details("tbl_privacy_statement", $id);
            $inputs = [
                'title',
                'content',
                'status'
        ...
        if(validate.all()){;    
            ...
            modal.standard(modal_obj, function(result){
                if(result){
                    ...
                    AJAX.update.table("tbl_privacy_statement");
                    ...
                    AJAX.update.exec(function(result){
                        ...
                        modal.alert("<?= $this->standard->dialog("update_success"); ?>", function(){
                            location.href = '<?=base_url("content_management/site_privacy_statement") ?>';
                        });
                    })
                }
            });          
