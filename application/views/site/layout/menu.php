							...
							<div class="au-acc">
								<button type="button" class="au-accbtn dropdown-toggle d-none d-lg-block" data-toggle="dropdown">
									...
									<div class="au-inner">
										...
										if(isset($points_details[0]->current_points)){
											echo $points_details[0]->current_points;
										}
										 ?> points</span>
									</div>
								</button>
								...
								<div class="au-dropdown dropdown-menu">
									...
									<?php if($_SESSION['is_admin'] == '1'){ ?>
										...
										<!--<a class="dropdown-item" href=""><i class="fas fa-file-invoice"></i> Report</a>-->
										<ul>
											<li>
											<a class="dropdown-item sub" href="<?= base_url('registered_volunteered')?>"><i class="fas fa-file-invoice"></i> Reports</a>
												<ul>
													<li>
