...
<html lang="en">
    <head>
        ...
        <?php
            ...
            $fullurl = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$request_uri";
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url();?>assets/site/css/lightslider.css">
