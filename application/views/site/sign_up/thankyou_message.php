			...
			<div class="au-form-wrapper au-inner au-max-height">
				...
				<div class="au-form-box au-flexcenter">
					<div class="au-inner">
						...
						<span class="au-h4">We have received your signup request</span>
						<span class="au-p2">A one-time password has been sent to the email address you submitted. A link has been provided to verify your identity. Please check your email.</span>
					</div>
				</div>
